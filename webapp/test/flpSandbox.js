		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "App Title",
									"targetURL": "#comcrossappcrossapp-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comcrossappcrossapp-display": {
								"semanticObject": "comcrossappcrossapp",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.crossapp.crossapp",
									"url": sap.ui.require.toUrl("com/crossapp/crossapp")
								}
							}
						}
					}
